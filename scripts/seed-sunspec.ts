...
const map111: RegisterDef[] = [
  ...
  { key: "frequencyHz", label: "Grid frequency (Hz)", address: B111 + 22, functionCode: 3, type: "float32", scale: 1, unit: "Hz" },
  ...
  { key: "powerFactor", label: "Power factor (PF)", address: B111 + 28, functionCode: 3, type: "float32", scale: 1, unit: "" },
  ...
  { key: "internalTempC", label: "Cabinet temperature (TmpCab)", address: B111 + 38, functionCode: 3, type: "float32", scale: 1, unit: "°C" },
