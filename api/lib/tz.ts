...
//
// tzOffsetMs and localClock now live in contracts/tz.ts: the browser needs the
// same reading of the clock to show which on-call shift is live. Re-exported
// so every existing server-side caller keeps importing them from here.
import { tzOffsetMs } from "@contracts/tz";
export { localClock, tzOffsetMs } from "@contracts/tz";
